...
- ✅ **8.2** `bg_loss` — **4.6e-15** vs fixed-T fixture; T-dependent here where upstream dies
- ➡️ **8.3** Kelvin evaporation — **moved to Phase 9**: loop-mode only (`--loop_evap_coef`)
...
- ✅ **8.6** Dilution — exact
- ⬜ **8.4** hydrates/RH · **8.7** sticking/ΔG scaling · **8.8** non-standard reactions · **8.9** charge balance
...
| Full test suite | **315 passed in 124 s** | Phase 7 close |
| Figures | 4, regenerated by `scripts/make_figures.py` | Phase 10 |
| Su73 / `constant_no_enhancement` vs fixtures | **4.9e-15** / **2.2e-15** | Phase 8.0 |
| `bg_loss` vs fixed-T fixture | **4.6e-15**, 52/52 | Phase 8.2 |
| Six wall-loss variants vs fixtures | all **< 5e-15**, zero patterns exact | Phase 8.5 |
| Dilution vs fixture | exact | Phase 8.6 |
